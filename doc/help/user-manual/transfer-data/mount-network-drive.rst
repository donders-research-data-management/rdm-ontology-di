...
Enter your username and the server address as https://webdav.data-acc.ru.nl. You can click the "+" symbol on the right to add it to your list of favorite servers.
...
Open File explorer, right-click on "Network", and click "map network drive". Then click "connect to a web site that you can use to store your documents and pictures" -> next -> choose custom network location -> next -> add network address https://webdav.data-acc.ru.nl.
